...
%Given findings from 1) the level of effort required porting this software; and
...
%explore each of the application areas mentioned above. --CEM - IS this suppose
%to say something not already said in the first paragraph?
%
% DM: Nope, it was literally just reiterating.
