...
\author{Nicholas~Malaya\superast \and D~McDougall\superast\superdag \and C~Michoski
  \and M~Lee \and C~Simmons}

\authorrunning{Nicholas~Malaya\superast \and D~McDougall \and
C~Michoski \and M~Lee \and C~Simmons} % if too long for running head

\institute{
\superast{}Institute for Computational Engineering and Sciences
(ICES),
The University of Texas at Austin \\
\email{\{nick,damon,michoski,mk,csim\}@ices.utexas.edu} \\
\\
\superdag{}\email{damon@ices.utexas.edu} ({\em corresponding author})
}
...
\bibliography{c,mk}   % name your BibTeX data base
