...
as a discretised partial differential equation, with a cheap surrogate.  This
...
QUESO is a C++ library for doing uncertainty quantification.
QUESO itself stands for Quantification of Uncertainty for Estimation, Simulation and Optimization. 
It is free and open source software and is available on GitHub: \url{http://libqueso.com}.
