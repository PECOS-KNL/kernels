...
was compiled with the flag ``{\tt -xMIC-AVX512}.'' \todo{should this be -ax not -x? MK: -x is okay if you are going to run it on compute node only.} Also, the FFTW-3.3.5
...
Ulerich. \todo{Maybe put Rhys in the acknowledgements? / MK: I think footnote is better. But I don't know if it is allowed.} The part of code used
