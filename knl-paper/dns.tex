...
named after the Korean god of storms\todo{is this right?}, 
...
%\todo{MK:Please tell me if this
%explanation is reasonable.}          
%
% NM -- yes and it is in fact expected. This has been observed on the MIC in 
%       other contexts
%
...
is tested and results are shown in Figure~\ref{fig:DNS_MPI_OpenMP}\todo{this doesnt make sense, isnt the data local?}. 
