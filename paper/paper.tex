...
\titlerunning{Experiences Porting Scientific Applications to the Intel “Knights Landing” (KNL) Xeon Phi Platform}
...
\authorrunning{Nicholas~Malaya\superast \and D.~McDougall \and C~Michoski \and M~Lee} % if too long for running head
